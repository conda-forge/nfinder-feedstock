...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nfinder-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15277&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nfinder-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nfinder` can be installed with:

```
conda install nfinder
```

It is possible to list all of the versions of `nfinder` available on your platform with:
